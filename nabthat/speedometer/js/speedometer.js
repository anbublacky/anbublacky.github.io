...
this.defaultProperty = {
    maxVal              : 35,         /**Max value of the meter*/
    divFact             : 10,          /**Division value of the meter*/
    dangerLevel         : 90,         /**more than this leval, color will be red*/
    initDeg             : 180,         /**reading begins angle*/
    maxDeg              : 180,         /**total angle of the meter reading*/
    edgeRadius          : 213,         /**radius of the meter circle*/
    speedNobeH          : 4,           /**speed nobe height*/
    speedoNobeW         : 200,          /**speed nobe width*/
    speedoNobeL         : 14,          /**speed nobe left position*/
  ...
  this.createIndicators = function(){
    for(var i=0; i<=noOfDev; i++){
      var curDig = this.defaultProperty.maxDeg - i*divDeg;
  ...
  this.changePosition = function (){   
    ...
    if(speed < 0 || isNaN(speed)){
     ...
     speedInDeg =self.defaultProperty.initDeg-(self.defaultProperty.maxDeg/self.defaultProperty.maxVal)*speed;
